...
pub enum Rs2Format {
    ...
    Any = sys::rs2_format_RS2_FORMAT_ANY as u32,
    ...
    ///
    Disparity16 = sys::rs2_format_RS2_FORMAT_DISPARITY16 as u32,
    ...
    ///   disparity = baseline * focal_length / depth
    ///
    Disparity32 = sys::rs2_format_RS2_FORMAT_DISPARITY32 as u32,
    /// Motion data packed as 3 32-bit fload values in [x, y, z] order
    MotionXyz32F = sys::rs2_format_RS2_FORMAT_MOTION_XYZ32F as u32,
    /// 8-bit raw image
    Raw8 = sys::rs2_format_RS2_FORMAT_RAW8 as u32,
    /// Four 10-bit per pixel luminance values packed into a 5-byte macropixel
    Raw10 = sys::rs2_format_RS2_FORMAT_RAW10 as u32,
    /// 16-bit raw image
    Raw16 = sys::rs2_format_RS2_FORMAT_RAW16 as u32,
    /// 8-bit red, green and blue channels (in that order)
    Rgb8 = sys::rs2_format_RS2_FORMAT_RGB8 as u32,
    /// 8-bit red, green, blue, and alpha channels (in that order)
    ///
    /// alpha channel is always equal to 0xFF
    Rgba8 = sys::rs2_format_RS2_FORMAT_RGBA8 as u32,
    /// Grey-scale image as a bit-packed array.
    ///
    /// 4 pixel data stream taking 5 bytes.
    W10 = sys::rs2_format_RS2_FORMAT_W10 as u32,
    /// 32-bit floating point 3D coordinates in [x, y, z] order
    Xyz32F = sys::rs2_format_RS2_FORMAT_XYZ32F as u32,
    /// 8-bit per pixel grayscale image
    Y8 = sys::rs2_format_RS2_FORMAT_Y8 as u32,
    /// 8-bit per pixel interleaved.
    ///
    /// 8-bit left, 8-bit right.
    Y8I = sys::rs2_format_RS2_FORMAT_Y8I as u32,
...
mod tests {
    ...
    fn all_variants_exist() {
        for i in 0..sys::rs2_format_RS2_FORMAT_COUNT as u32 {
            assert!(

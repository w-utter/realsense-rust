...
use realsense_rust::{Config, Context, Format as RsFormat, Pipeline, Rs2StreamKind};
...
async fn main() -> Result<()> {
    ...
    let config = Config::new()?.enable_stream(Rs2StreamKind::Pose, 0, 0, 0, RsFormat::_6Dof, 200)?;
